...
@Component(service = LifecycleAction.class, immediate = true, property = { "key=login.events.pre" })
public class LoginPreAction implements LifecycleAction, EnumerationStreamSupport {

    private static final String LIFECYCLE_ACtION_TYPE = "login.events.pre";
