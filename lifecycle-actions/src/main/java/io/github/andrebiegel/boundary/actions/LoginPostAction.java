...
@Component(service = LifecycleAction.class, immediate = true, property = { "key=login.events.post" })
public class LoginPostAction implements LifecycleAction, EnumerationStreamSupport {

    private static final String LIFECYCLE_ACtION_TYPE = "login.events.post";
