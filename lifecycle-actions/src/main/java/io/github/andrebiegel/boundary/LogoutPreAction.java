...
@Component(service = LifecycleAction.class, immediate = true, property = { "key=logout.events.pre" })
public class LogoutPreAction implements LifecycleAction, EnumerationStreamSupport {

    private static final String LIFECYCLE_ACtION_TYPE = "logout.events.pre";
