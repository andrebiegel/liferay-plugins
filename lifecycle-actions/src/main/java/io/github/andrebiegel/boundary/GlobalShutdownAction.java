...
@Component(service = LifecycleAction.class, immediate = true, property = { "key=global.shutdown.events" })
public class GlobalShutdownAction implements LifecycleAction, EnumerationStreamSupport {

    private static final String LIFECYCLE_ACtION_TYPE = "global.shutdown.events";
