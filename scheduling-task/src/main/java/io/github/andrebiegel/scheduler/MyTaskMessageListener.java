...
public class MyTaskMessageListener extends BaseMessageListener {
  ...
  /**
   * activate: Called whenever the properties for the component change (aka Config Admin)
  ...
  protected void activate(Map<String,Object> properties) throws SchedulerException {
    ...
    // if we were initialized (i.e. if this is called due to Config-Admin modification)
    if (_initialized) {
